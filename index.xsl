...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="campaigns">
    <div  id="campaigns-boxes" class="cycle-slideshow"  data-cycle-pause-on-hover="true" data-cycle-speed="500"  data-cycle-timeout="9000" data-cycle-slides="a"  data-cycle-fx="scrollHorz" data-cycle-swipe="true">
      ...
      <xsl:for-each select="/buildinfo/textsetbackup/campaigns/campaign[@id='ilovefs' or @id='amaelle' or @id='appelbaum']">
        <!-- <xsl:for-each select="/buildinfo/textsetbackup/campaigns/campaign[@id='ilovefs' or @id='freesociety' or @id='amaelle' or @id='dfd' or @id='appelbaum']"> -->
        <xsl:choose>
