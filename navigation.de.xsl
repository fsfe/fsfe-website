	...
	<td valign="top" class="TopBody">
		<table summary="" width="150" border="0" cellspacing="0" cellpadding="4">
            ...
            <tr>
              ...
              <xsl:choose>
                <xsl:when test="$path='about/about.xhtml'">Über</xsl:when>
                <xsl:otherwise>
                  <a href="{$fsfeurope}/about/about.html">Über</a>
                </xsl:otherwise>
              </xsl:choose><br/>
              ...
              <xsl:choose>
                <xsl:when test="$path='about/graphics/graphics.de.xhtml'">Grafiken</xsl:when>
                <xsl:otherwise>
		  <a href="{$fsfeurope}/about/graphics/graphics.de.html">Grafiken</a>
                </xsl:otherwise>
              </xsl:choose><br/>
              <br/></td>
            </tr>
