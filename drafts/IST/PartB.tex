...
\\ \\
Furthermore, the availabiliy of such software that makes high quality 
free software development a reachable reality for everyone had already
encouraged free software development. Platforms like Savannah or SourceForge
have allowed a huge number of people to launch their project and to simplify
its diffusion. We are confident that the availability of an platform that is
trivial to install and configure will encourage the creation of lots of hosting
facilities in Europe and then encourages Free software development.
