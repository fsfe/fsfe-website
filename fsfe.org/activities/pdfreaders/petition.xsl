...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:template match="/buildinfo/document/body/include-signatures">
    ...
    <h3 id="businesses"><xsl:call-template name="fsfe-gettext"><xsl:with-param name="id" select="'bsig'"/></xsl:call-template>
    ...
    <h3 id="individuals"><xsl:call-template name="fsfe-gettext"><xsl:with-param name="id" select="'isig'"/></xsl:call-template>
