    ...
    <xsl:for-each select="/buildinfo/document/set/buglist">
      ...
      <xsl:element name="table">
        <xsl:element name="tr">
          ...
          <xsl:element name="th">
            <xsl:value-of select="/buildinfo/document/text[@id='institution-address']"/>
          </xsl:element>
          <xsl:element name="th">
            <xsl:value-of select="/buildinfo/document/text[@id='institution-url']"/>
          </xsl:element>
          <xsl:element name="th">
        ...
        <xsl:for-each select="bug">
          <xsl:element name="tr">
            ...
            <xsl:element name="td">
              <xsl:value-of select="@institution-address"/>
            </xsl:element>
            <xsl:element name="td">
              <xsl:element name="a">
