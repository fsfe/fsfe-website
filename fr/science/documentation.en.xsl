...
<html lang="en">
  <head>
    <title>FSF France - Free software for scientific documentation</title>
  </head>
  <body>
	...
	English | <a href="documentation.fr.html">French</a>
	]
      </center>
      <p />

<p align="center"><font size="+2"><b>Free software for scientific documentation</b></font>
<font size="-2">(Listed by various contributors.)</font>
</p>

  <p align="center">This page lists different free software usefull to
  produce scientific documentation. It was compelled part of the <a
...
<TH>URL</TH>
    ...
    Updated:
    <!-- timestamp start -->
    $Date: 2002-03-02 18:21:05 $ $Author: olberger $
    <!-- timestamp end -->
