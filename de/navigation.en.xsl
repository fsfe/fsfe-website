...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match="/html[@lang='en']/body/div">
	...
	<td class="TopTitle">
	  ...
	  &nbsp;<a href="http://germany.fsfeurope.org/index.en.html">index.en.html" class="T1">Germany</a>
	</td>
      </tr>
    </table>
...
<!--   		<tr><td class="TopTitle" align="center">Projects</td></tr>
		  ...
		  <td class="TopBody" align="right">
            ...
            <tr>
              ...
              <xsl:choose>
                ...
                <xsl:otherwise>
                  <a href="{$fsfgermany}/index.html" class="T2">Home</a>
                </xsl:otherwise>
              </xsl:choose><br/>
              <xsl:choose>
                <xsl:when test="$path='contact/contact.xhtml'">Contact</xsl:when>
                <xsl:otherwise>
                  <a href="{$fsfgermany}/contact/contact.html" class="T2">Contact</a>
                </xsl:otherwise>
              </xsl:choose><br/>
              <xsl:choose>
                <xsl:when test="$path='about/index.xhtml'">About</xsl:when>
                <xsl:otherwise>
                  <a href="{$fsfgermany}/about/index.html" class="T2">About</a>
                </xsl:otherwise>
              </xsl:choose><br/>
              <xsl:choose>
                <xsl:when test="$path='help/help.xhtml'">Help</xsl:when>
                <xsl:otherwise>
                  <a href="{$fsfgermany}/help/help.html" class="T2">Help</a>
                </xsl:otherwise>
              </xsl:choose><br/>
              <xsl:choose>
                <xsl:when test="$path='background.xhtml'">Background</xsl:when>
                <xsl:otherwise>
                  <a href="{$fsfgermany}/background.html" class="T2">Background</a>
                </xsl:otherwise>
              </xsl:choose><br/>
              <xsl:choose>
                <xsl:when test="$path='documents/documents.xhtml'">Documents</xsl:when>
                <xsl:otherwise>
                  <a href="{$fsfgermany}/documents/documents.html" class="T2">Documents</a>
                </xsl:otherwise>
              </xsl:choose><br/>
              <xsl:choose>
                <xsl:when test="$path='mailman/index.xhtml'">Mailing Lists</xsl:when>
                <xsl:otherwise>
                  <a href="{$fsfgermany}/mailman/index.html" class="T2">Mailing Lists</a>
                </xsl:otherwise>
              </xsl:choose><br/>
              <xsl:choose>
                <xsl:when test="$path='news/news.xhtml'">News</xsl:when>
                <xsl:otherwise>
                  <a href="{$fsfgermany}/news/news.html" class="T2">News</a>
                </xsl:otherwise>
              </xsl:choose><br/>
              <xsl:choose>
                <xsl:when test="$path='events/events.en.xhtml'">Events</xsl:when>
                <xsl:otherwise>
                  <a href="{$fsfgermany}/events/events.en.html" class="T2">Events</a>
                </xsl:otherwise>
              </xsl:choose><br/>
              <xsl:choose>
                <xsl:when test="$path='press/index.xhtml'">Press Section</xsl:when>
                <xsl:otherwise>
                  <a href="{$fsfgermany}/press/index.html" class="T2">Press Section</a>
                </xsl:otherwise>
              </xsl:choose><br/>
              <xsl:choose>
                <xsl:when test="$path='speakers/index.xhtml'">Speakers</xsl:when>
                <xsl:otherwise>
                  <a href="{$fsfgermany}/speakers/index.html" class="T2">Speakers</a>
                </xsl:otherwise>
              </xsl:choose><br/>
              <br/></td>
            </tr>
	...
	<td class="TopTitle">
          ...
          &nbsp;&nbsp;<a href="{$fsfgermany}/fsfe-de.xsl" class="T1">XSL Style
	  Sheet</a>&nbsp;&nbsp;| <a
