		...
		<tr>
		  <td class="TopBody" align="right">
		    ...
		    <a href="{$fsfeurope}/documents/whyfs.cs.html">Mluvíme o svobodném software</a><br />
              <a href="{$fsfeurope}/education/education.cs.html">Svobodný software a vzdělávání</a><br />
                  <a href="{$fsfeurope}/law/eucd/eucd.cs.html">EUCD</a><br />
            ...
            <tr>
              ...
              <xsl:choose>
                <xsl:when test="$path='help/donate-2002.cs.xhtml'">Přispějte</xsl:when>
                <xsl:otherwise>
                  <a href="{$fsfeurope}/help/donate-2002.cs.html">Přispějte</a>
                </xsl:otherwise>
              </xsl:choose><br/>

              <xsl:choose>
                <xsl:when test="$path='help/thankgnus-2002.cs.xhtml'">Poděkování</xsl:when>
                <xsl:otherwise>
                  <a href="{$fsfeurope}/help/thankgnus-2002.cs.html">Poděkování</a>
                </xsl:otherwise>
              </xsl:choose><br/>
              ...
              <xsl:choose>
                <xsl:when test="$path='speakers/speakers.cs.xhtml'">Mluvčí</xsl:when>
                <xsl:otherwise>
                  <a href="{$fsfeurope}/speakers/speakers.cs.html">Mluvčí</a>
                </xsl:otherwise>
              </xsl:choose><br/>
              <xsl:choose>
                <xsl:when test="$path='gbn/index.cs.xhtml'">Obchodní síť GNU</xsl:when>
                <xsl:otherwise>
                  <a href="{$fsfeurope}/gbn/index.cs.html">Obchodní síť GNU</a>
                </xsl:otherwise>
              </xsl:choose><br/>
              <xsl:choose>
