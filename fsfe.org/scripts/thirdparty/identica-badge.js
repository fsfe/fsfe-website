...
// Modified to point to user feeds, 2010-01-22 by MJR
...
function createHTMLElement(tagName) {
  ...
  else var elem = document.createElement(tagName);
    ...
    function (sub, type, scheme, url, word, offset, full) {
      ...
      switch (type) {
        ...
        case "https://": // html links
          ...
          break;
        case "@": // link users
          href = "http://" + server + "/" + moniker;
          break;
        case "!": // link groups
          href = "http://" + server + "/group/" + moniker;
          break;
        case "#": // link tags
          href = "http://" + server + "/tag/" + moniker;
          break;
    ...
    return {
        ...
        try {
          var f = Function(
            [
              ...
              json
                .replace(/<\!--.+-->/gim, "")
                .replace(/\bfunction\b/g, "function&shy;"),
              ");",
            ].join(""),
          );
          return f();
      ...
      buildPresentation: function () {
        ...
        var rules = {
          ...
          ".cite":
            "{" +
            setZoom +
            "font-weight:bold;margin:0px 0px 0px 4px;padding:0px;display:block;font-style:normal;line-height:" +
            $.a.thumbnailSize / 2 +
            "px;vertical-align:middle;}",
          ".cite a": "{color:#C15D42;}",
          ".date":
            "{margin:0px 0px 0px 4px;padding:0px;display:block;font-style:normal;line-height:" +
            $.a.thumbnailSize / 2 +
            "px;vertical-align:middle;}",
          ".date:after":
          ...
          h4:
            ...
            $.a.headerBackground +
            ";text-align:right;margin:0px;padding:" +
            $.a.padding +
            "px;}",
          ...
          img:
            ...
            "px;}",
          p:
            "{margin:2px 0px 0px 0px;padding:0px;width:" +
            $.a.innerWidth +
          ...
          "ul li":
            ...
            ";margin:0px;padding:" +
            $.a.padding +
            "px;list-style:none;width:auto;overflow:hidden;border-bottom:1px solid #D8E2D7;}",
      ...
      renderResult: function (r) {
        ...
        for (var i = 0; i < r.length; i++) {
          ...
          //               img.alt = 'profile image for ' + r[i].user.screen_name;
          ...
          //               a.href = 'http://' + $.a.server + '/' + r[i].user.screen_name;
          //               a.onclick = function() {
          //                  $.f.changeUserTo(this);
          //                  return false;
          //               };
