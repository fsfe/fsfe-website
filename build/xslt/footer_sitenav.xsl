    ...
    <xsl:element name="nav">
      ...
      <xsl:element name="ul">
                    ...
                    <xsl:for-each select="/buildinfo/menuset/menu[@parent='fsfe']">
                      ...
                      <xsl:element name="li">
                        <xsl:choose>
                          ...
                          <xsl:otherwise>
                            <xsl:element name="a">
                              <xsl:attribute name="href"><xsl:value-of select="$urlprefix"/><xsl:value-of select="." /></xsl:attribute>
                              <xsl:call-template name="fsfe-gettext"><xsl:with-param name="id" select="$id" /></xsl:call-template>
                            </xsl:element>
                          </xsl:otherwise>
                        </xsl:choose>
        ...
        <xsl:element name="li">
          ...
          <xsl:element name="a">
            <xsl:attribute name="href"><xsl:value-of select="$urlprefix"/>/donate/donate.html#ref-fullmenu</xsl:attribute>
          ...
          <xsl:element name="ul">
            ...
            <xsl:element name="li">
              <xsl:attribute name="class">fellowship</xsl:attribute>
              <xsl:element name="a">
                <xsl:attribute name="href"><xsl:value-of select="$urlprefix"/>/fellowship/</xsl:attribute>
        ...
        <xsl:element name="li">
          ...
          <xsl:element name="a">
              <xsl:attribute name="href"><xsl:value-of select="$urlprefix"/>/news/</xsl:attribute>
        ...
        <xsl:element name="li">
          ...
          <xsl:element name="a">
              <xsl:attribute name="href"><xsl:value-of select="$urlprefix"/>/legal/</xsl:attribute>
        ...
        <xsl:element name="li">
          ...
          <xsl:element name="a">
              <xsl:attribute name="href"><xsl:value-of select="$urlprefix"/>/freesoftware/</xsl:attribute>
