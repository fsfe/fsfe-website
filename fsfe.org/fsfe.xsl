        ...
        <xsl:choose>
          ...
          <xsl:otherwise>
            ...
            <xsl:choose>
              ...
              <xsl:otherwise>
                <xsl:text>The Free Software Foundation Europe is a charity that empowers users to control technology. We enable people to use, understand, adapt, and share software.</xsl:text>
              </xsl:otherwise>
            </xsl:choose>
          </xsl:otherwise>
        </xsl:choose>
