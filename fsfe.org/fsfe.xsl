...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dt="http://xsltsl.org/date-time" xmlns:str="http://exslt.org/strings" version="1.0" exclude-result-prefixes="dt" extension-element-prefixes="str">
  ...
  <xsl:include href="../xslt/internal/fsfe_head.xsl"/>
  <xsl:include href="../xslt/internal/fsfe_body.xsl"/>
  <xsl:include href="../xslt/internal/gettext.xsl"/>
  <xsl:include href="../xslt/internal/static-elements.xsl"/>
  <xsl:include href="../xslt/internal/fsfe-cd.xsl"/>
  <xsl:include href="../xslt/internal/module.xsl"/>
  <xsl:include href="../xslt/internal/related.xsl"/>
  <xsl:include href="../xslt/internal/email-obfuscate.xsl"/>
  <xsl:include href="../xslt/internal/peertube.xsl"/>
  ...
  <xsl:include href="../xslt/internal/fsfe_document.xsl"/>
  <xsl:include href="../xslt/internal/fsfe_headings.xsl"/>
  <xsl:include href="../xslt/internal/fsfe_localmenu.xsl"/>
  <!-- Do not copy non-HTML elements to output -->
  <xsl:include href="../xslt/internal/fsfe_nolocal.xsl"/>
</xsl:stylesheet>
