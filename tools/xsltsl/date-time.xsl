<?xml version="1.0"?>
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:doc="http://xsltsl.org/xsl/documentation/1.0" xmlns:dt="http://xsltsl.org/date-time" xmlns:str="http://xsltsl.org/string" version="1.0" extension-element-prefixes="doc str">
  <doc:reference xmlns="">
    <referenceinfo>
  ...
  <doc:template xmlns="" name="dt:format-date-time">
  ...
  <doc:template xmlns="" name="dt:calculate-day-of-the-week">
  ...
  <doc:template xmlns="" name="dt:calculate-last-day-of-month">
  ...
  <xsl:template name="dt:calculate-last-day-of-month">
    ...
    <xsl:choose>
      <xsl:when test="$month = 2">
        <xsl:choose>
          <xsl:when test="($year mod 4) = 0 and (($year mod 400) = 0                           or ($year mod 100) != 0)">29</xsl:when>
  ...
  <doc:template xmlns="" name="dt:get-day-of-the-week-name">
  ...
  <doc:template xmlns="" name="dt:get-day-of-the-week-abbreviation">
  ...
  <doc:template xmlns="" name="dt:get-month-name">
  ...
  <doc:template xmlns="" name="dt:get-month-abbreviation">
  ...
  <doc:template xmlns="" name="dt:calculate-julian-day">
  ...
  <doc:template xmlns="" name="dt:format-julian-day">
  ...
  <doc:template xmlns="" name="dt:calculate-week-number">
  ...
  <doc:template xmlns="" name="dt:get-month-number">
  ...
  <doc:template xmlns="" name="dt:get-xsd-datetime-year">
  ...
  <doc:template xmlns="" name="dt:get-xsd-datetime-month">
  ...
  <doc:template xmlns="" name="dt:get-xsd-datetime-day">
  ...
  <doc:template xmlns="" name="dt:get-xsd-datetime-hour">
  ...
  <doc:template xmlns="" name="dt:get-xsd-datetime-minute">
  ...
  <doc:template xmlns="" name="dt:get-xsd-datetime-second">
  ...
  <doc:template xmlns="" name="dt:get-xsd-datetime-timezone">
