...
\section*{GET - groupe PeCoVall}
GET (I'll have the official presentation on friday).\\ 
The PeCoVall group is composed of 5 professors and researchers 
from the 3 institutions ENST, ENST Bretagne and INT, that provide high education
in telecommunication.

This group has been formed last year to set up a project under GPL on an hosting 
environment specialy designed for high education. 
The members of the group are much concerned with free/open software and during the 
last three years, they organised five conferences related to free/open software 
in their institutions. One member is also a Debian maintener. 
