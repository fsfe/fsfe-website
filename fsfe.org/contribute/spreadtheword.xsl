...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:import href="../../xslt/internal/countries.xsl"/>
          ...
          <xsl:element name="div">
                ...
                <xsl:element name="abbr">
                  ...
                  <xsl:attribute name="title">
                    <xsl:call-template name="fsfe-gettext">
                      <xsl:with-param name="id" select="'stw-printed-tooltip'"/>
                    </xsl:call-template>
                  </xsl:attribute>
                  <xsl:element name="strong">
                    <!-- Field name -->
                    <xsl:call-template name="fsfe-gettext">
                      <xsl:with-param name="id" select="'stw-printed'"/>
                    </xsl:call-template>
                  </xsl:element>
                  <!-- /strong -->
                </xsl:element>
            ...
            <xsl:element name="p">
              ...
              <xsl:if test="/buildinfo/document/set/info[@id=$id]/type != ''">
                <xsl:element name="strong">
                  <xsl:call-template name="fsfe-gettext">
                    <xsl:with-param name="id" select="'stw-type'"/>
                  </xsl:call-template>
                  <xsl:text>: </xsl:text>
                </xsl:element>
              ...
              <xsl:if test="/buildinfo/document/set/info[@id=$id]/size != ''">
                <xsl:element name="strong">
                  <xsl:call-template name="fsfe-gettext">
                    <xsl:with-param name="id" select="'stw-size'"/>
                  </xsl:call-template>
                  <xsl:text>: </xsl:text>
                </xsl:element>
              ...
              <xsl:if test="/buildinfo/document/set/info[@id=$id]/context != ''">
                <xsl:element name="strong">
                  <xsl:call-template name="fsfe-gettext">
                    <xsl:with-param name="id" select="'stw-context'"/>
                  </xsl:call-template>
                  <xsl:text>: </xsl:text>
                </xsl:element>
              ...
              <xsl:if test="/buildinfo/document/set/info[@id=$id]/languages != ''">
                <xsl:element name="span">
                  ...
                  <xsl:element name="abbr">
                    ...
                    <xsl:attribute name="title">
                      <xsl:call-template name="fsfe-gettext">
                        <xsl:with-param name="id" select="'stw-languages-tooltip'"/>
                      </xsl:call-template>
                    </xsl:attribute>
                    <xsl:element name="strong">
                      <!-- Field name -->
                      <xsl:call-template name="fsfe-gettext">
                        <xsl:with-param name="id" select="'stw-languages'"/>
                      </xsl:call-template>
                    </xsl:element>
                    <!-- /strong -->
                  </xsl:element>
              ...
              <xsl:if test="/buildinfo/document/set/info[@id=$id]/license != ''">
                <xsl:element name="strong">
                  <xsl:call-template name="fsfe-gettext">
                    <xsl:with-param name="id" select="'stw-license'"/>
                  </xsl:call-template>
                  <xsl:text>: </xsl:text>
                </xsl:element>
              ...
              <xsl:if test="/buildinfo/document/set/info[@id=$id]/author != ''">
                <xsl:element name="strong">
                  <xsl:call-template name="fsfe-gettext">
                    <xsl:with-param name="id" select="'stw-author'"/>
                  </xsl:call-template>
                  <xsl:text>: </xsl:text>
                </xsl:element>
              ...
              <xsl:if test="/buildinfo/document/set/info[@id=$id]/year != ''">
                <xsl:element name="strong">
                  <xsl:call-template name="fsfe-gettext">
                    <xsl:with-param name="id" select="'stw-year'"/>
                  </xsl:call-template>
                  <xsl:text>: </xsl:text>
                </xsl:element>
                <xsl:value-of select="$year"/>
              ...
              <xsl:if test="/buildinfo/document/set/info[@id=$id]/source != ''">
                <xsl:element name="span">
                  ...
                  <xsl:element name="abbr">
                    ...
                    <xsl:attribute name="title">
                      <xsl:call-template name="fsfe-gettext">
                        <xsl:with-param name="id" select="'stw-source-tooltip'"/>
                      </xsl:call-template>
                    </xsl:attribute>
                    <xsl:element name="strong">
                      <!-- Field name -->
                      <xsl:call-template name="fsfe-gettext">
                        <xsl:with-param name="id" select="'stw-source'"/>
                      </xsl:call-template>
                    </xsl:element>
                    <!-- /strong -->
                  </xsl:element>
              ...
              <xsl:if test="/buildinfo/document/set/info[@id=$id]/printready != ''">
                <xsl:element name="span">
                  ...
                  <xsl:element name="abbr">
                    ...
                    <xsl:attribute name="title">
                      <xsl:call-template name="fsfe-gettext">
                        <xsl:with-param name="id" select="'stw-printready-tooltip'"/>
                      </xsl:call-template>
                    </xsl:attribute>
                    <xsl:element name="strong">
                      <!-- Field name -->
                      <xsl:call-template name="fsfe-gettext">
                        <xsl:with-param name="id" select="'stw-printready'"/>
                      </xsl:call-template>
                    </xsl:element>
                    <!-- /strong -->
                  </xsl:element>
  ...
  <xsl:template match="country-list">
    <xsl:call-template name="country-list">
      ...
      <xsl:with-param name="subset" select="'promo'"/>
    </xsl:call-template>
  </xsl:template>
